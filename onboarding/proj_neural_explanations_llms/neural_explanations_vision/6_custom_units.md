...
- [ ]  Generate compositional explanations for the 10 units of your choice (they must be different from the random one selected in Task 3 (Onboarding))
...
- [ ]  Briefly comment on the differences and similarities between explanations computed for these neurons and the neurons explained in Task 3 (Onboarding)
